                ...
                if(message.trim().equalsIgnoreCase("@exit")){ // Exiting the chat
                  this.interrupt();
                      ...
                      try {
                        ...
                        path = "C:\\Users\\Student.SCI000A083\\Documents\\NetBeansProjects\\networks\\src\\main\\dog.png";
                      }
                      //path = "C:\\Users\\Arjun\\Desktop\\Networks2a\\src\\main\\dog.png"; // Need to be removed later
                      path = "/home/c/cppkus001/Desktop/Networks2a/src/main/dog.png";

                      // Getting the outputstream of socket to send file
                      OutputStream out = socket.getOutputStream();

                      // Requesting the server to receive a file from this client
                      p = new PrintWriter(out); // get the output stream to the server
                      p.println("@ReceiveFileRequest: File Received from port " + socket.getLocalPort()); // sends the message to the server
